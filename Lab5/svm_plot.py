...
def plot_contours(clf, points):
    ...
    ax.scatter(X0, X1, cmap=plt.cm.coolwarm, s=80, edgecolors='k')
    
    # ax.scatter(X0[clf.support_],X1[clf.support_],c=labels[clf.support_], cmap=plt.cm.coolwarm, s=80, edgecolors='w')
    ax.scatter(X0[clf.support_],X1[clf.support_], cmap=plt.cm.coolwarm, s=80, edgecolors='w')
